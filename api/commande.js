...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const SITES_URLS = {
      ...
      'Maisons du Monde': `https://www.google.com/search?q=${query}+site:maisonsdumonde.com&tbm=shop`,
      'La Redoute': `https://www.google.com/search?q=${query}+site:laredoute.fr&tbm=shop`,
